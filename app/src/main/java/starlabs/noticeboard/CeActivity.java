...
public class CeActivity extends AppCompatActivity {
    EditText et_ce, et_jpg,et_pdf;
    Button btn_ce,btn_speech;
    ...
    DatabaseReference refce,imagerefce,pdfrefce;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et_ce = (EditText) findViewById(R.id.et_ce);
        choose_pdf = (TextView) findViewById(R.id.choose_pdf);
        upload_pdf = (TextView) findViewById(R.id.upload_pdf);
        et_jpg = (EditText) findViewById(R.id.et_jpg);
        et_pdf=(EditText) findViewById(R.id.et_pdf);
        choose_jpg = (TextView) findViewById(R.id.choose_jpg);
        upload_jpg = (TextView) findViewById(R.id.upload_jpg);
        imageView = (ImageView) findViewById(R.id.img);
        progressBar=(ProgressBar)findViewById(R.id.pb);
        FirebaseDatabase database = FirebaseDatabase.getInstance();
        refce = database.getReference("Notification");
        imagerefce=database.getReference("Images");
        pdfrefce=database.getReference("Pdf");
        ...
        btn_ce.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String notice = et_ce.getText().toString();
                Upload up=new Upload(notice);
                if (!TextUtils.isEmpty(notice)) {
                    refce.child("CE").push().child("Notice").setValue(up);
                    Toast.makeText(CeActivity.this, "Added successfully", Toast.LENGTH_SHORT).show();
                    et_ce.setText("");
                }
    ...
    private void uploadpdffiles(Uri filePath) {
        if(TextUtils.isEmpty(et_pdf.getText()))
        {
            ...
            pdfref = storageReference.child("CE Pdf").child(et_pdf.getText().toString());
            ...
            pdfref.putFile(filePath)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Toast.makeText(CeActivity.this, "File Uploaded successfully", Toast.LENGTH_SHORT).show();
                            Upload upload = new Upload(et_pdf.getText().toString(), taskSnapshot.getDownloadUrl().toString());
                            pdfrefce.child("CE").push().setValue(upload);
                            et_pdf.setText("");
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception exception) {
                            Toast.makeText(CeActivity.this, exception.getMessage(), Toast.LENGTH_LONG).show();
                        }
                    })
    ...
    private void uploadImage(Uri filePath) {
        if(TextUtils.isEmpty(et_jpg.getText()))
        {
            ...
            progressBar.setVisibility(View.VISIBLE);
            imageref = storageReference.child("CE Images").child(et_jpg.getText().toString());
            ...
            imageref.putFile(filePath)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            imagerefce.child("CE").push().setValue(upload);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        else if(requestCode == REQ_CODE_SPEECH_INPUT && resultCode == RESULT_OK && null !=data)
        {
            ...
            et_ce.setText(result.get(0));
        }
        else{
            Toast.makeText(CeActivity.this, "No file chosen", Toast.LENGTH_SHORT).show();
        }
